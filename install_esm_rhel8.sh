#!/bin/bash
# Install Hyper-V Enhanced Session Mode on RHEL8
...
# After the script have finished if you named the machine "RHEL8-GUI";
# run in Powershell on Host: Set-VM -VMName "RHEL8-GUI" -EnhancedSessionTransportType HvSocket
